...
class Control:
    ...
    # dump memory to file
    def dump(self):
        # with open(self.file[:-3] + '_pipelined_out.txt', 'w') as file:
        output_file = f"{self.file[:-3]}_pipelined_out_{self.cache_size}_{self.numBlocksPerSet}_{self.blockSize}.txt"
