...
class Control:
    def __init__(self, numSets, numBlocksPerSet, blockSize, cache_size):
    ...
    # dump memory to file
    def dump(self):
        # with open(self.file[:-3]+'_nonpipelined_out.mc', 'w') as file:
        output_file = f"{self.file[:-3]}_nonpipelined_out_{self.cache_size}_{self.numBlocksPerSet}_{self.blockSize}.txt"
